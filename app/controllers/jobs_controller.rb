class JobsController < ApplicationController
  ...
  def jobs_params
    params.require(:job).permit(:title, :description, :location, :salary_id, :category_id, :company, :experience_level_id, :latitude, :longitude, :responsibilities, :requirements)
  end
